...
- **DiffusionModels** - (Un)Conditional Diffusion Models: A framework that implements (un)conditional diffusion models to perform data assimilation and compares the results with other traditional methods (EnKF, DKF). Available in Python. Collaborator: David Hernandez (GitHub: david-hrnndz, Mail: david.hernandez@studenti.unipd.it).
