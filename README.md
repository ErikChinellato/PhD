...
- **DiffusionModels** - (Un)Conditional Diffusion Models: A framework that implements (un)conditional diffusion models to perform data assimilation and compares the results with other traditional methods (EnKF, DKF). Available in Python. Contributor: David Hernandez ([GitHub](https://github.com/david-hrnndz), [Mail](mailto:david.hernandez@studenti.unipd.it)).
